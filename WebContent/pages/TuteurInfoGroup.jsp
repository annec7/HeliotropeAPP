...
<html>
<head>
<title>Students' Information by Group</title>
<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
		...
		<%
			...
			ArrayList<UserBean> alist = tbc.showUserByGroup();
		...
		<form action="/Heli/pages/PageTuteur.jsp" method="post" >
			<label>
				<button class="btn btn-default" type="submit" style="width: 155px;font-weight: bold">Return Back</button>
			</label>
		</form>
	</div>
</body>
